...
- **{doc}`Variables <Variables>`**: Using variable placeholders, solving linear and quadratic equations.
- **{doc}`Functions <Functions>`**: Domain mapping, linear equations, slope, and intercept.
- **{doc}`Curvilinear Functions <Curvilinear>`**: Working with non-linear curves, parabolas, exponentials, logs, and limits.
...
- **{doc}`Limits <Limits>`**: Understanding limits, continuity, and formal definitions.
